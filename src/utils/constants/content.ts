...
export const movieTime = 'Время';
export const movieAge = 'Возраст';
export const movieCountry = 'Страна';
export const movieSelectCoutry = 'Выберите страну';
...
export const movieCast = 'Актеры';
export const movieCasts = 'В ролях:';
...
export const copyBtn = 'Копировать';
export const replyBtn = 'Ответить';
...
export const slideSize = 'Cоотношение сторон слайда 1700х910px(редактирование отключено)'
export const loading = 'Загрузка...';
export const resetForm = 'Сбросить'
